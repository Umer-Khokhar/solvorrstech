...
const Services = () => {
  return (
    <section id="features" className="py-24 lg:py-40 overflow-hidden bg-white dark:bg-n-8 relative transition-colors duration-500">
      ...
      <div className="container relative z-10">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-24 lg:mb-32">
            ...
            <FadeIn delay={0.1}>
                <h2 className="text-5xl md:text-7xl font-bold text-n-1 dark:text-white leading-[1.1] tracking-tight mb-8" style={{ fontFamily: 'var(--font-clash-grotesk)' }}>
            ...
            <FadeIn delay={0.2}>
                <p className="body-1 text-n-3 dark:text-n-4 max-w-2xl">
                    We combine strategic thinking with technical mastery to build scalable software that drives real, measurable impact.
                </p>
            </FadeIn>
        </div>
        ...
        <FadeIn delay={0.6} className="mt-24 lg:mt-32 text-center">
            <div className="group inline-flex flex-col items-center cursor-pointer">
                <span className="text-n-3 dark:text-n-4 font-mono text-[10px] uppercase tracking-[0.4em] mb-4 font-black opacity-50">Discovery Phase</span>
                <div className="flex items-center gap-4 border-b border-n-1/10 dark:border-white/10 pb-2 group-hover:border-color-1 transition-colors">
                    <span className="text-2xl font-bold text-n-1 dark:text-white">View Full Service Catalog</span>
