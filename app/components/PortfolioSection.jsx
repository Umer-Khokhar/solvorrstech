...
const coreValues = [
  {
    ...
    description:
      "Continuously refining SEO to stay ahead of search engine updates.",
  },
  {
    name: "Client Focused",
    icon: "./icons/client.webp",
    description:
      "Your success drives us; we craft custom SEO solutions for impact.",
  },
  {
    name: "Transparency",
      ...
      <div className="max-w-[90%] mx-auto bg-gradient-to-r p-16 md:p-28 flex flex-col items-center justify-center rounded-4xl from-color-1/10 via-color-2/10 to-color-3/10">
        <div className="max-w-6xl mx-auto h-full">
          <div className="heading text-center">
            <h2 className="h3 font-semibold mb-20">
          ...
          <div className="relative flex items-center flex-col md:flex-row justify-between gap-16">
            ...
            <div className="max-w-[400px] flex flex-col gap-16">
              <div>
                ...
                <p>
                  Our mission is to boost online presence with cutting-edge SEO,
                  driving organic traffic, increasing visibility, and delivering
                  measurable results.
                </p>
              </div>
              <div>
