    ...
    <div className={`py-[4rem] z-20 relative transition-colors duration-300`}>
      <div className="container lg:flex z-10">
        <div className="max-w-[35rem]">
          ...
          <StaggerContainer
            className="max-w-[22rem] mb-10 md:mb-14 flex flex-col gap-6"
            delayChildren={0.4}
          >
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-16 lg:mt-0">
          ...
          <BlurIn delay={0.5} duration={1}>
            <div className="relative left-1/2 flex lg:-mt-[4rem] -translate-x-1/2 w-[22rem] aspect-square border border-n-4 rounded-full scale:75 md:scale-100">
