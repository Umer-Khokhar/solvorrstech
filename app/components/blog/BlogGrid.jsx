...
const BlogGrid = () => {
  ...
  const filteredData = blogData.filter((blog) => {
    let searchFilter = blog.title
      .toLowerCase()
      .includes(searchTerm.toLowerCase());
    let categoriesFilter = blog.category
      .toLowerCase()
          ...
          <FadeIn>
            <div>
              ...
              <p className="text-n-3 dark:text-n-4 max-w-xl">
                Stay informed with the latest news, tutorials, and insights from
                our team of experts.
              </p>
            </div>
          </FadeIn>
