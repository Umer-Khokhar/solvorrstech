const AboutHero = () => {
    ...
    const TechIllustration = () => (
        <svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
            ...
            <g transform="translate(180 100) rotate(15)">
                <rect x="0" y="0" width="150" height="90" rx="10" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.2)" strokeWidth="1" className="backdrop-blur-sm" />
                <text x="15" y="25" fill="white" fontSize="12" fontWeight="bold">Dashboard</text>
            ...
            <g transform="translate(60 80)">
                <circle cx="0" cy="0" r="15" fill="rgba(236, 72, 153, 0.1)" stroke="#ec4899" strokeWidth="1" />
                <circle cx="0" cy="0" r="5" fill="#ec4899" />
            </g>

            {/* <!-- Medium floating node --> */}
            <g transform="translate(320 220)">
                <circle cx="0" cy="0" r="25" fill="rgba(168, 85, 247, 0.1)" stroke="#a855f7" strokeWidth="1" />
    ...
    return (
        <section className="relative overflow-hidden">
            ...
            {/*    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(139,92,246,0.15),_transparent_40%)]"></div>*/}
            {/*    <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0MCIgaGVpZ2h0PSI0MCIgdmlld0JveD0iMCAwIDQwIDQwIj48Zz48cGF0aCBmaWxsPSJub25lIiBzdHJva2U9IiMyNzI3MjciIHN0cm9rZS13aWR0aD0iMC41IiBkPSJNMCAyMCBIIDQwIE0gMjAgMCBWIDQwIiAvPjwvZz48L3N2Zz4=')] bg-repeat"></div>*/}
            {/*</div>*/}

            <div className="relative min-h-[90vh] flex items-center mt-12 max-w-[1400px] mx-auto px-6 lg:px-8 py-24 sm:py-32">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-20 items-center">
                    {/* Left Column: Text Content */}
                    <div className="text-center lg:text-left">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white tracking-tight text">
                        ...
                        <p className="mt-6 text-lg text-gray-300 max-w-xl mx-auto lg:mx-0">
                            Every obstacle is an invitation to innovate. At Solvorr Tech, we cut through complexity—designing sleek web apps, automating the tedious, and driving digital marketing that actually converts. When growth feels stuck, we're the team that gets things moving.
                        </p>
                        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8">
                            ...
                            <div className="text-center">
                                <p className="text-4xl font-bold text-white">9.3K+</p>
