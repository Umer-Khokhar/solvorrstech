          ...
          >
            ...
            <div className="text-center lg:text-left space-y-8">
              ...
              >
                ...
                <span className="text-sm font-code text-n-3 uppercase tracking-wider font-semibold">
                  Who We Are
                </span>
              </motion.div>
                ...
                <div className="flex items-center gap-4 text-n-3">
                  <div className="flex -space-x-3">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-10 h-10 rounded-full border-2 border-n-8 bg-n-7 flex items-center justify-center text-xs font-bold text-n-1 uppercase"
                      >
              ...
              >
                <div>
                  <p className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-n-1 to-n-1/50">
                    7+
                  </p>
                  <p className="text-sm text-n-4 mt-2 font-medium uppercase tracking-wide">
                    Years Experience
                  </p>
                </div>
                <div>
              ...
              <div className="relative z-10 w-full max-w-md">
                  ...
                  <div className="p-6 flex flex-col h-full justify-between relative z-10">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-n-3">
                        Scalable, high-performance architectures built for
                        growth.
                      </p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="p-6 flex flex-col h-full justify-between relative z-10">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-n-1 mb-2">
                        Design
                      </h3>
                      <p className="text-xs text-n-3">
                        User-centric interfaces that captivate and convert.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-n-4 uppercase font-bold">
                        Growth
                      </p>
