    ...
    <div className={"!px-0 bg-n-7 !py-12"}>
      <div className={"!px-0 bg-n-7 !py-20"}>
        <div className="container">
          ...
          <div className="relative flex flex-col-reverse md:flex-row items-center lg:justify-center gap-10 xl:mx-auto">
            {/* content section  */}
            <div className="relative ">
              <p className="body-2 text-n-3 max-w-3xl mb-4">
                We are a team of four skilled professionals dedicated to helping
                small businesses establish a strong online presence. Our
                expertise lies in web development, custom dashboards, API
                integrations, and full-stack applications.
              </p>
              <p className="body-2 text-n-3 max-w-3xl mb-4">
                Our goal? To provide affordable, high-quality, and scalable
                solutions tailored to small businesses. Whether you're looking
                for a website, web app, or backend API, we ensure that our
                solutions are designed to help you grow.
              </p>
