  ...
  const values = [
    {
      ...
      description:
        "We design systems with clear architecture in mind — building dashboards and workflows that bring structure, clarity, and operational stability to growing businesses.",
      icon: benefitIcon1,
    },
    {
      number: "02",
      ...
      description:
        "Consistency matters. Every system and automation we deliver is tested, stable, and built to perform reliably in real business environments.",
      icon: benefitIcon2,
    },
    {
      number: "03",
      ...
      description:
        "Our dashboards help businesses clearly understand clients, revenue, workflows, and performance through structured and centralized data.",
      icon: benefitIcon3,
    },
    {
      number: "04",
      ...
      description:
        "We work closely with businesses to understand how their operations actually run, ensuring systems and automation align with real workflows.",
      icon: benefitIcon4,
    },
    {
      number: "05",
      ...
      description:
        "We build systems designed to grow with your business — supporting increasing clients, data, and operational complexity without losing structure.",
      icon: benefitIcon1,
    },
    {
      number: "06",
      ...
      description:
        "We help businesses strengthen their online discoverability through structured search optimization and strong local search presence.",
      icon: benefitIcon2,
    },
  ];
    ...
    <section className="relative py-16 md:py-32 px-5 bg-n-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="h2 font-bold">The Principles Behind Our Systems</h2>
          <p className="body-1 text-n-4 max-w-2xl mx-auto leading-relaxed">
            These principles guide how we design business systems, build
            automation, and improve search visibility—ensuring every solution is
            reliable, scalable, and aligned with real business operations.
          </p>
        </div>
