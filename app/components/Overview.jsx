      ...
      >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
            ...
            <div className="w-full flex justify-between mt-6 px-4 pt-6 border-t border-slate-900/5 dark:border-white/5">
                <div className="text-center group cursor-default">
                    <div className="text-[10px] uppercase font-bold tracking-widest text-slate-500 dark:text-slate-400 mb-1">Scale</div>
                    <div className="bg-slate-100 dark:bg-white/10 px-3 py-1 rounded-full text-xs font-semibold text-slate-700 dark:text-white group-hover:bg-color-1 group-hover:text-white transition-colors">Unlimited</div>
                </div>
                <div className="text-center group cursor-default">
                   <div className="text-[10px] uppercase font-bold tracking-widest text-slate-500 dark:text-slate-400 mb-1">Speed</div>
                   <div className="bg-slate-100 dark:bg-white/10 px-3 py-1 rounded-full text-xs font-semibold text-slate-700 dark:text-white group-hover:bg-color-2 group-hover:text-white transition-colors">Lightning</div>
                </div>
                <div className="text-center group cursor-default">
                   <div className="text-[10px] uppercase font-bold tracking-widest text-slate-500 dark:text-slate-400 mb-1">Security</div>
                   <div className="bg-slate-100 dark:bg-white/10 px-3 py-1 rounded-full text-xs font-semibold text-slate-700 dark:text-white group-hover:bg-green-500 group-hover:text-white transition-colors">Enterprise</div>
                </div>
            </div>
        ...
        >
            <div className="backdrop-blur-xl bg-white/90 dark:bg-slate-800/90 p-4 rounded-xl shadow-xl border border-white/20 flex items-center gap-3">
                ...
                <div>
                     <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Growth</div>
                     <div className="text-sm font-bold text-slate-900 dark:text-white">+145% YoY</div>
                </div>
            </div>
        </motion.div>
        ...
        >
             <div className="backdrop-blur-xl bg-white/90 dark:bg-slate-800/90 p-4 rounded-xl shadow-xl border border-white/20 flex items-center gap-3">
                ...
                <div>
                     <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Performance</div>
          ...
          <div className="order-2 lg:order-1">
             ...
             >
                ...
                <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm">
                    ...
                    <span className="text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Overview</span>
                </div>
                ...
                <div className="mb-8 space-y-4 text-slate-600 dark:text-n-4 text-base md:text-lg leading-relaxed">
                 ...
                 <div className="space-y-4 mb-10">
                    {["Scalable Architecture", "Premium Experience", "24/7 Expert Support"].map((item, i) => (
