        ...
        <section className={"py-12 lg:py-28 bg-n-7"}>
            <div className="container">
                ...
                <div className={"md:w-[50%]"}>
                    <h3 className={'h3 font-bold'}><Target className={'inline-block w-12 h-12 text-color-1'}/>{content.title}</h3>
                    <h6 className={"h6 my-4 text-n-2"}>{content.subTitle}</h6>
                    <p className={'text-n-3 mb-4'}>{content.description}</p>
