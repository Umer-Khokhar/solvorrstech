        ...
        switch (section.type) {
          case "paragraph":
            return (
              <p
                key={index}
                className="text-n-3 dark:text-n-4 leading-relaxed mb-6 text-lg"
              >
                {section.text}
              </p>
            );
          case "heading":
            return (
              <h2 key={index} className="h2 mt-12 mb-6 text-n-1 dark:text-n-2">
                {section.text}
              </h2>
            );
          case "quote":
            return (
              <blockquote
                key={index}
                className="relative py-8 px-10 my-12 border-l-4 border-color-1 bg-color-1/5 rounded-r-3xl italic"
              >
            ...
            return (
              <ul key={index} className="space-y-4 my-8">
                {section.items.map((item, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-3 text-n-3 dark:text-n-4"
                  >
            ...
            return (
              <ol key={index} className="space-y-4 my-8">
                {section.items.map((item, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-4 text-n-3 dark:text-n-4"
                  >
